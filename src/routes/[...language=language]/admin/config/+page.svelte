    ...
    <div class="container space-y-2 py-12">
        ...
        <div class="grid grid-cols-2 gap-12">
            ...
            <div class="space-y-2">
                ...
                <input type="text" class="textfield" placeholder="Adres" bind:value={data.configuration.adres}>
                <input type="text" class="textfield" placeholder="Telefoon" bind:value={data.configuration.phone}>
            </div>

            <div class="space-y-2">
                <p class="font-medium">Sociale Media</p>
                <input type="text" class="textfield" placeholder="Facebook URL" bind:value={data.configuration.facebook_url}>
                <input type="text" class="textfield" placeholder="Twitter URL" bind:value={data.configuration.twitter_url}>
