...
<div class="container space-y-8 py-12">
    ...
    <div class="space-y-1">
        <p class="font-semibold text-xl">Synopsis</p>
                <p class="opacity-50 text-xs">Een zeer korte beschrijving. Wordt gebruikt bij het linken naar jouw nieuwsbericht.</p>
        <input type="text" class="textfield" placeholder="Synopsis" bind:value={data.news_item.synopsis}>
    </div>
    ...
    <div class="space-y-1">
        ...
        <textarea type="text" class="w-full" rows="10" placeholder="Inhoud" bind:value={data.news_item.content}></textarea>
    </div>
    ...
    <div class="space-y-1">
        ...
        <input type="date" class="textfield" placeholder="Auteur" bind:value={data.news_item.published_at}>
    </div>

    <div class="">
        <div class="flex items-center gap-2">
            <input id="default-checkbox" type="checkbox" value="" class="check" bind:checked={data.news_item.published}>
